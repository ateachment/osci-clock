...
**Channel Display:** Ensure that **only Channel 2 (CH2) is selected for display** (or select the dedicated **XY display mode** depending on your scope's interface) so the instrument plots CH1 against CH2 instead of rendering standard dual traces.
